...
class Video extends Component {
  ...
  renderPlayer() {
    ...
    const inline = {
      height: disableAniHeight ? '100%' : inlineHeight,
      alignSelf: 'stretch'
    }
      ...
      <Animated.View
        style={[
          ...
          fullScreen ?
            ...
            : { height: disableAniHeight ? '100%' : this.animInline },
...
Video.propTypes = {
  ...
  disableAniHeight: PropTypes.bool,
}
